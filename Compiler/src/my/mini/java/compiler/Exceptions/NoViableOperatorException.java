 ...
 */
public class NoViableOperatorException extends RuntimeException
{

    public NoViableOperatorException(String msg, Token className, String methodName, Token variable, String sourceName)
    {
        super(msg);

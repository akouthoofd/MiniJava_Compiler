...
.method public Insert(I)I
    ...
    ldc 1                                                               ; Loading in boolean constant(true)
    istore 5                                                            ; Storing item into cont
finally_5:
    iload 5                                                         ; Getting cont's value from local pool
    ifeq else_5
    aload 4                                                            ; Loading object
    invokevirtual Tree/GetKey()I
    istore 6                                                            ; Storing item into key_aux
    iload 1                                                         ; Getting v_key's value from local pool
    iload 6                                                         ; Getting key_aux's value from local pool
...
.method public Delete(I)I
    ...
    ldc 1                                                               ; Loading in boolean constant(true)
    istore 7                                                            ; Storing item into is_root
finally_10:
    iload 4                                                         ; Getting cont's value from local pool
    ifeq else_10
    aload 2                                                            ; Loading object
    invokevirtual Tree/GetKey()I
    istore 8                                                            ; Storing item into key_aux
    iload 1                                                         ; Getting v_key's value from local pool
    iload 8                                                         ; Getting key_aux's value from local pool
...
finally_14:
  ...
  finally_16:
    goto finally_15
  else_15:
    iload 7                                                         ; Getting is_root's value from local pool
    ifeq else_17
    aload 2                                                            ; Loading object
    invokevirtual Tree/GetHas_Right()I
...
finally_18:
    ifeq else_21
    ldc 1                                                               ; Loading in boolean constant(true)
    istore 6                                                            ; Storing item into ntb
    goto finally_21
  else_21:
...
.method public Print()I
    ...
    istore 1                                                            ; Storing item into ntb
    ldc 1                                                               ; Loading in boolean constant(true)
